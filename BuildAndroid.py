...
3) View the contents of sources.list file

					''')
					repo = raw_input("\033[1;32mWhat do you want to do ?> \033[1;m")
					if repo == "1":
						cmd1 = os.system("add-apt-repository 'deb http://archive.ubuntu.com/ubuntu $(lsb_release -sc) main universe restricted multiverse")
					elif repo == "2":
						cmd2 = os.system("apt-get update -m")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
